...
const config: Config = {
  ...
  tagline: 'Bridging Large Language Models, Perception, and Robot Control',
  ...
  url: 'https://physical-ai-textbook.org',
  ...
  plugins: [
    // Plugin to inject the ChatbotWidget into all pages
